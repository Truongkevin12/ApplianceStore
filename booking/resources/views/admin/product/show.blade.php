            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    @foreach ($product as $products )
                        <tr>
                            ...
                            <td><img src="{{ Storage::url('images/' . $products->image) }}" width="100px" height="100px" alt="Product Image"></td>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-end">
                        ...
                        <li class="page-item"><a class="page-link" href="{{ $product->url($product->currentPage() + 1) }}">2</a></li>
                        <li class="page-item"><a class="page-link" href="{{ $product->url($product->currentPage() + 2) }}">3</a></li>
