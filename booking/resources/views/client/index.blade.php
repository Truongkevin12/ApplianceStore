...
<body data-spy="scroll" data-target="#topnav-menu" data-offset="60">
            ...
            <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <img src="{{ Storage::url('images/' . $banners->image)}}" alt="..." class="d-block img-fluid">
                        <div class="carousel-caption d-none d-md-block text-white-50">
                            <h5 class="text-white">{{ $banners->title }}</h5>
        ...
        <section class="section" id="team">
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="owl-carousel owl-theme events navs-carousel owl-loaded owl-drag" id="team-carousel">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1395px;"><div class="owl-item active" style="width: 255px; margin-right: 24px;"><div class="item">
                            <div class="card text-center team-box">
                                ...
                                <div class="card-footer bg-transparent border-top">
                                    <div class="d-flex mb-0 team-social-links">
                                        ...
                                        <div class="flex-fill">
                                            <a href="#" data-toggle="tooltip" title="" data-original-title="Linkedin">
                                                <i class="mdi mdi-linkedin"></i>
                                            </a>
                                        </div>
                                        <div class="flex-fill">
                                            <a href="#" data-toggle="tooltip" title="" data-original-title="Google">
                        ...
                        </div></div><div class="owl-item active" style="width: 255px; margin-right: 24px;"><div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                        ...
                        </div></div><div class="owl-item" style="width: 255px; margin-right: 24px;"><div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
